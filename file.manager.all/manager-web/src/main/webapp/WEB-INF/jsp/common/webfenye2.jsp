...
<div style="text-align: left;font-size: 14px;color: green;margin-top: 100px;">
	总记录数：${pageView.rowCount}条 | 每页显示：${pageView.pageSize}条 |
	总页数：${pageView.pageCount}页｜ 当前页：${pageView.pageNow} &nbsp;&nbsp;&nbsp;
	<a href="javascript:void(0);" onclick="pageNow('1');"> 首页 </a>&nbsp;&nbsp;&nbsp;
	<c:if test="${pageView.pageNow eq 1}">
		<span class="disabled"> 上一页 </span>&nbsp;&nbsp;&nbsp;
</c:if>
	<c:if test="${pageView.pageNow ne 1}">
		<a href="javascript:void(0);"
			onclick="return pageNow('${pageView.pageNow - 1}')"> 上一页 </a>&nbsp;&nbsp;&nbsp;
</c:if>
...
&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);"
			onclick="pageNow('${pageView.pageNow + 1}')"> 下一页 </a>
	</c:if>
	<c:if test="${pageView.pageNow eq pageView.pageCount}">	
&nbsp;&nbsp;&nbsp;<span class="disabled"> 下一页 </span>
	</c:if>
	&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);"
		onclick="pageNow('${pageView.pageCount}')"> 尾页 </a>
</div>