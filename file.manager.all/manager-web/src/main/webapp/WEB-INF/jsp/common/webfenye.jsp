...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td><table width="100%" border="0" cellspacing="0"
				cellpadding="0">
				<tr>
					<td class="STYLE4">&nbsp;&nbsp;总记录数:<span id="rowCount">${pageView.rowCount}</span>条
						|每页显示:<span id="pageSize">${pageView.pageSize}</span>条 | 总页数:<span
						id="pageCount">${pageView.pageCount}</span>页
					</td>
					<td>
						<table border="0" align="right" cellpadding="0" cellspacing="0" id="pageTable">
...
function page(pageNow) {
	...
	var pCount = parseInt($("#pageCount").html());
	if (pageNow < 1) {
 ...
 */
function initPageView(pageData,callback){
	...
	$("#rowCount").html(pageData.rowCount);
	$("#pageSize").html(pageData.pageSize);
	$("#pageCount").html(pageData.pageCount);
	...
	$("#pageTable").append("<tr>"+td1+td2+td3+td4+td5+"</tr>");
}
</script>
