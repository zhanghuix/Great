		...
		<table class="ttab" height="100" width="70%" border="0" cellpadding="0" cellspacing="1"
			...
			<tr>
				<td height="30"
					 colspan="2">
					<div align="center">
					<font color="blue" size="6" ><b>编辑资源</b></font>
					</div>
				</td>
			</tr>
			<tr>	
					...
					<td >
						...
						<select name="parentId">
							...
							<c:forEach var="key" items="${resLists}">
								<option value="${key.no}" <c:if test="${key.no eq resources.parentId}">selected="selected"</c:if>>${key.name}</option>
							</c:forEach>
						</select>
						</div>
					</td>
			...
			<tr>	
					...
					<td >
						<div align="left" class="STYLE1"  style="padding-left:10px;">
						<input style="height: 20px;width: 200px" name="name" value="${resources.name}" id="name"/>
						</div>
					</td>
				</tr>
				<tr>	
					...
					<td >
						<div align="left" class="STYLE1"  style="padding-left:10px;">
						<input style="height: 20px;width: 200px" name="resKey" value="${resources.resKey}" id="resKey"/>
						</div>
					</td>
				</tr>
				<tr>	
					...
					<td>
						<div align="left" class="STYLE1"  style="padding-left:10px;">
						<input style="height: 20px;width: 200px" name="resUrl" value="${resources.resUrl}" id="resUrl"/>
						</div>
					</td>
				</tr>
				<tr>	
				...
				<tr>	
					...
					<td >
						<div align="left" class="STYLE1"  style="padding-left:10px;">
						<input style="height: 20px;width: 200px" name="level" value="${resources.level}" id="level"/>
						</div>
					</td>
				</tr>
				<tr>	
