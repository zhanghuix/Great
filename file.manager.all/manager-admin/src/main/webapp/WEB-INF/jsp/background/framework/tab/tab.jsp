...
<body bgcolor="#353c44">
<div>
<center style="color: white;font-weight: 800;font-size: 30px;" >尊贵的： <span style="color: yellow;font-weight: 800;">${admin.loginName}</span> 您好！！！！ 欢迎进入管理系统:</center>
<dir style="color: white;font-size: 20px;">
你的身份是: <span style="color: yellow;">
 <c:if test="${admin.type eq '0'}">超级管理员</c:if>
  <c:if test="${admin.type eq '1'}"> 普通用户</c:if>
  </span>
