...
function toSetting(){
	...
	var jobKeyArray=checkAll();
	
	if(jobKeyArray == null){
		return ;
	}
	
	 var url = "${pageContext.servletContext.contextPath }/background/quartzJob/toSetting.html?jobKey="+jobKeyArray;
	 var h_sp1 = 400;
	 var w_sp1 = 550;
...
function toAllStartOrShutdown(type){
	...
	toAjax(type,jobKeyArray);
	
 }
 
 
 
 function toStartOrShutdown(type,jobKey){
	 toAjax(type,jobKey);
 }
 ...
 function checkAll(){
	 var jobKeyArray="";
		...
		for(var i = 0; i < checks.length; i++)
		{
			...
			{
				istrue=true;
				jobKeyArray=jobKeyArray+checks[i].value+",";
			}
		}
 ...
 function toAjax(type,jobKeyArray){
	 var url="${pageContext.servletContext.contextPath }/background/quartzJob/start.html";
		//停止
		if(type=="N"){
			url="${pageContext.servletContext.contextPath }/background/quartzJob/shutdown.html";
		}
	    $.ajax({
	   		async:false, //请勿改成异步，下面有些程序依赖此请数据
	   		type : "POST",
	   		data:{"jobKey":jobKeyArray},
	   		url: url,
	   		dataType:'json',
...
<body>
<form id="fenye" name="fenye" action="${pageContext.servletContext.contextPath }/background/quartzJob/query.html" method="post">
<table width="100%">
  <tr>
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：系统管理-定时任务设置</td>
              </tr>
            </table></td>
              ...
              <tr>
                ...
                <td width="52"><table width="88%">
                  <tr>
                    ...
                    <td class="STYLE4">
                    <a href="javascript:void(0);"  onclick="toAllStartOrShutdown('N')">
                    	关闭
                    </a>
                    	</td>
                  </tr>
               ...
               <td width="60"><table width="90%">
                  <tr>
                    ...
                    <td class="STYLE1"><div align="center"> 
                    <a href="javascript:void(0);"  onclick="toAllStartOrShutdown('Y')">
                    	开启
                    </a></div></td>
                  </tr>
                </table></td>
                <td width="60"><table width="90%">
                  <tr>
                    <td class="STYLE1"><div align="center"><img src="${pageContext.servletContext.contextPath }/images/22.gif" width="14" height="14" /></div></td>
                    <td class="STYLE1"><div align="center"> 
                    <a href="javascript:void(0);"  onclick="toSetting()">
                    	设置
                    </a></div></td>
                  </tr>
                </table></td>
  	...
  	<div class="search_k" align="left">
		<fieldset class="search">
			...
			<div class="search_content">
				任务名：<input type="text" name="authLoginName" value="${param.authLoginName}" style="height: 20px"/>　　
				任务key：<input type="text" name="hcType" value="${param.hcType}" style="height: 20px"/>　
      ...
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            ...
            <td width="12%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif" ><span class="STYLE1">任务名称</span></td>
            <td width="12%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif" ><span class="STYLE1">状态</span></td>
            <td width="12%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">任务组名称</td>
            <td width="15%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">任务key</td>
            <td width="15%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">调度时间</td>
          ...
          <tr>
            <td height="20" >
              <input type="checkbox" name="check" value="${key.jobKey}" />
            </td>
            
            <td height="20" ><span class="STYLE1">${key.jobName}</span></td>
            <td height="20" ><span class="STYLE1">${key.state}</span></td>
            <td height="20" ><span class="STYLE1">${key.jobGroup}</span></td>
            <td height="20" ><span class="STYLE1">${key.jobKey}</span></td>
            
            <td height="20" ><span class="STYLE1">${key.jobTime}
            <%-- <fmt:parseDate value="${key.jobTime}" var="date" pattern="yyyy-MM-dd HH:mm:ss" />
            ...
            <a href="javascript:void(0);" onclick="toStartOrShutdown('Y','${key.jobKey}')">
                                     开启
            </a>
            &nbsp; &nbsp;
           </sec:authorize>
           <sec:authorize ifAnyGranted="ROLE_sys_user_delete">
            <img src="${pageContext.servletContext.contextPath }/images/del.gif" width="16" height="16" />
            	<a href="javascript:void(0);" onclick="toStartOrShutdown('N','${key.jobKey}')">
            	停止</a>
            	</sec:authorize>
            	</span></td>
          </tr>
