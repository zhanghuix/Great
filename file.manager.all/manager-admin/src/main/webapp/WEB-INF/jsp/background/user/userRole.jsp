...
<html>
  ...
  function allocation(){
       $.ajax({
      		...
      		type : "POST",
      		data:{userNo:"${user.no}",roleNo:$('input[name="roleNo"]:checked').val()},
...
<br/>  
      ...
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          ...
          <tr>
            <td height="20" >
              <input type="radio" name="roleNo" value="${role.no}" />
            </td>
				...
				<tr>
					<td colspan="2" style="padding: 10px">
						<div align="center">
							...
							<input id="backBt" type="button" value="　关　闭　" class="input_btn_style1"
								   onclick="closeDaglog()"/>
		 				</div>
					</td>
				</tr>
