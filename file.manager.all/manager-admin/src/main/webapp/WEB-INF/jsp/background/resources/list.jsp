                ...
                <td width="52"><table width="88%">
                 ...
                 <td width="60"><table width="90%">
                  <tr>
                    ...
                    <td class="STYLE1"><div align="center"> 
                    <a href="${pageContext.servletContext.contextPath }/background/resources/addUI.html">
                    	新增
                    </a>
                    </div></td>
		...
		<fieldset class="search">
			...
			<div class="search_content">
              ...
              <input type="button" value="重置" class="input_btn_style1"
                     onclick="location.href='${pageContext.servletContext.contextPath }/background/resources/query.html'"/>
			</div>
		</fieldset>
	</div>
  </td>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            <td width="3%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif" >
 			...
 			<td width="10%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">资源名</td>
            <td width="15%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif" ><span class="STYLE1">资源KEY</span></td>
            <td width="20%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif" ><span class="STYLE1">资源URL</span></td>
            <td width="10%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">资源类型</td>
            <td width="8%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">优先级</td>
            <td width="8%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">上级资源</td>
            <td width="10%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">创建时间</td>
          ...
          <tr>
            <td height="20" >
              <input type="checkbox" name="check" value="${resources.no}" />
            </td>
            
            <td height="20" ><span class="STYLE1"><a href="${pageContext.servletContext.contextPath }/background/resources/getById.html?rescNo=${resources.no}&&typeKey=0">
            	${resources.name}</a></span></td>
            ...
            <td height="20" ><span class="STYLE1">
             <fmt:parseDate value="${resources.createTime}" var="date" pattern="yyyy-MM-dd HH:mm:ss" />
            ...
            <a href="${pageContext.servletContext.contextPath }/background/resources/getById.html?rescNo=${resources.no}&&typeKey=1">
                                     编辑
            </a>
            &nbsp; &nbsp;
            </sec:authorize>
            ...
            <img src="${pageContext.servletContext.contextPath }/images/del.gif" width="16" height="16" />
            	<a href="javascript:void(0);" onclick="deleteId('${pageContext.servletContext.contextPath }/background/resources/deleteById.html?rescNo=${resources.no}')">
            	删除</a></sec:authorize>
            	</span></td>
          </tr>
          </c:forEach>
