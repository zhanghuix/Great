...
public class RoleController {
	...
	public String add(Model model,Roles role,String rescNo){
	...
	public String deleteById(Model model,String roleNo){
		rolesService.delete(roleNo);
		return "redirect:query.html";
	}
	...
	public String getById(Model model,String roleNo,int typeKey){
		Roles role = rolesService.getById(roleNo);
